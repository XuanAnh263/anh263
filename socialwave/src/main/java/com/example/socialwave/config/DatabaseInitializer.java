...
//        userRepository.save(user);
        ...
        List<User> usersToAdd = List.of(
                ...
                new User("admin5@gmail.com", passwordEncoder.encode("user4567238"), "user4",6L,true)
        ...
        List<Conversation> conversationsToAdd = List.of(
                new Conversation(1L,"Conversation 1", "avatar_url_1", "Description for Conversation 1", ConversationType.PERSONAL, ConversationStatus.ACTIVE, LocalDateTime.now(), LocalDateTime.now(), 1L),
                new Conversation(2L,"Conversation 2", "avatar_url_2", "Description for Conversation 2", ConversationType.PERSONAL, ConversationStatus.ACTIVE, LocalDateTime.now(), LocalDateTime.now(),1L),
                new Conversation(3L,"Conversation 3", "avatar_url_2", "Description for Conversation 2", ConversationType.PERSONAL, ConversationStatus.ACTIVE, LocalDateTime.now(), LocalDateTime.now(),1L),
                new Conversation(4L,"Conversation 4", "avatar_url_2", "Description for Conversation 2", ConversationType.PERSONAL, ConversationStatus.ACTIVE, LocalDateTime.now(), LocalDateTime.now(),1L)
